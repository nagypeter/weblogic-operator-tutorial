...
This lab demonstrates how to deploy and run Weblogic Domain container packaged Web Application on Kubernetes Cluster using [Oracle WebLogic Server Kubernetes Operator](https://github.com/oracle/weblogic-kubernetes-operator).
...
1. [Install WebLogic Operator](install.operator_oow.md)
2. [Deploy WebLogic Domain](deploy.weblogic_oow.md)
3. [Scaling WebLogic Cluster](scale.weblogic_oow.md)
