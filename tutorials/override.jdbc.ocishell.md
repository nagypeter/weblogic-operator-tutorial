...
For more details see the [Configuration overrides documentation](https://oracle.github.io/weblogic-kubernetes-operator/userguide/managing-domains/configoverrides/)
